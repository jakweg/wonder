...
function findMinY(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
...
function findMaxY(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
...
function findMinX(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
  for (let x = boundingBox.minX; x < boundingBox.maxX; x++)
    for (let y = boundingBox.minY; y < boundingBox.maxY; y++)
      for (let z = boundingBox.minZ; z < boundingBox.maxZ; z++) {
        const id = rawBlockData[y * blocksPerY + x * sizeZ + z] as BlockId
...
function findMaxX(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
...
function findMinZ(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
  for (let z = boundingBox.minZ; z < boundingBox.maxZ; z++)
    for (let y = boundingBox.minY; y < boundingBox.maxY; y++)
      for (let x = boundingBox.minX; x < boundingBox.maxX; x++) {
        const id = rawBlockData[y * blocksPerY + x * sizeZ + z] as BlockId
...
function findMaxZ(rawBlockData: Uint8Array, blocksPerY: number, sizeZ: number, boundingBox: BoundingBox): void {
