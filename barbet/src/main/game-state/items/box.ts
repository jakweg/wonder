...
const vertexes = /* @__PURE__ */ lazy(() => new Float32Array(rootVertexes
	.map((e, i) => {
		if (i % 4 === 3)
			return e // flags
		e += 0.5
...
const vertexesInHand = /* @__PURE__ */ lazy(() => new Float32Array(rootVertexes
	.map((e, i) => {
		if (i % 4 === 3)
			return e // flags
		e *= 0.9
...
const elements = /* @__PURE__ */ lazy(() => new Uint8Array([
	// bottom
	1, 2, 0,
	2, 3, 0,
	// bottom front
