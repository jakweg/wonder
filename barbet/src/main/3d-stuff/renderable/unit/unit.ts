...
export const createNewUnitRenderable = (renderer: MainRenderer) => {
	const unitData = [
		// position: x,y,z ; primary color: r,g,b, secondary color: r,g,b
		6, 2, 14, 1, 0.6171875, 0.00390625, 0.62890625, 0.99609375, 0.40625,
		8, 2, 5, 0, 0.37890625, 0.53515625, 0, 0.58984375, 0.63671875,
		10, 2, 9, 0.984375, 0.703125, 0.140625, 0.9921875, 0.99609375, 0.78125,
	]
	...
	program.enableAttribute(program.attributes.worldPosition, 3, true, 9 * floatSize, 0, 1)
	program.enableAttribute(program.attributes.primaryColor, 3, true, 9 * floatSize, 3 * floatSize, 1)
	program.enableAttribute(program.attributes.secondaryColor, 3, true, 9 * floatSize, 6 * floatSize, 1)
	...
	const instancesCount = unitData.length / 9 | 0
	return {
