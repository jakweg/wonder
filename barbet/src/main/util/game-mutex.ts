...
export const waitAsyncCompat = useNativeWaitAsync ?
    Atomics.waitAsync : ((typedArray: Int32Array, index: number, value: bigint, timeout?: number): WaitAsyncResult => {
    ...
    return {
        enterForUpdate(): void {
            ...
            while (true) {
                ...
                if (Atomics.load(array, 0) === UPDATE_BIT)
                    return // success: now we have exclusivity
            }
        },
