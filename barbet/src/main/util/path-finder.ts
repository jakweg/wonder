...
export const findPathDirectionsExperimental = (
	sx: number, sy: number,
	dx: number, dy: number,
	dSize: number,
	tester: WalkableTester): Direction[] | null => {
	...
	const destinationRectLeft = (dx - dSize) | 0
	const destinationRectRight = (dx + dSize) | 0
	const destinationRectTop = (dy - dSize) | 0
	const destinationRectBottom = (dy + dSize) | 0
